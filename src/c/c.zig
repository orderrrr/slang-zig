...
pub const TypeParameterReflection = c.TypeParameterReflection;
pub const VariableLayoutReflection = c.VariableLayoutReflection;
pub const EntryPointReflection = c.EntryPointReflection;
pub const TypeReflection = c.TypeReflection;
pub const FunctionReflection = c.FunctionReflection;
pub const VariableReflection = c.VariableReflection;
pub const TypeLayoutReflection = c.TypeLayoutReflection;
pub const GenericReflection = c.GenericReflection;
pub const Modifier = c.Modifier;
pub const AttributeReflection = c.Attribute;
pub const ShaderReflection = c.ShaderReflection;
...
pub const SlangCompileTarget = enum(i32) {
    TARGET_UNKNOWN,
    TARGET_NONE,
    GLSL,
...
pub fn createGlobalSession(gs: *c.IGlobalSession) SlangResult {
    return @enumFromInt(c.createGlobalSession(gs));
}

pub fn createSession(gs: c.IGlobalSession, sessionDesc: *const c.SessionDesc, session: *c.ISession) SlangResult {
    return @enumFromInt(c.createSession(gs, sessionDesc, session));
}
...
pub fn findProfile(gs: c.IGlobalSession, profile: []const u8) c.SlangProfileID {
    return c.findProfile(gs, profile.ptr);
}
...
pub fn ProgramLayout_getTypeParameterByIndex(layout: c.ProgramLayout, index: u32) TypeParameterReflection {
    return c.ProgramLayout_getTypeParameterByIndex(layout, @intCast(index));
}

pub fn ProgramLayout_findTypeParameter(layout: c.ProgramLayout, name: []const u8) TypeParameterReflection {
    return c.ProgramLayout_findTypeParameter(layout, @ptrCast(name.ptr));
}

pub fn ProgramLayout_getParameterByIndex(layout: c.ProgramLayout, index: u32) VariableLayoutReflection {
...
pub fn ProgramLayout_getEntryPointByIndex(layout: c.ProgramLayout, index: u32) c.EntryPointReflection {
...
pub fn ProgramLayout_findTypeByName(layout: c.ProgramLayout, name: []const u8) c.TypeReflection {
    return c.ProgramLayout_findTypeByName(layout, @ptrCast(name.ptr));
}

pub fn ProgramLayout_findFunctionByName(layout: c.ProgramLayout, name: []const u8) c.FunctionReflection {
    return c.ProgramLayout_findFunctionByName(layout, @ptrCast(name.ptr));
}

pub fn ProgramLayout_findFunctionByNameInType(layout: c.ProgramLayout, t: c.TypeReflection, name: []const u8) c.FunctionReflection {
    return c.ProgramLayout_findFunctionByNameInType(layout, t, @ptrCast(name.ptr));
}

pub fn ProgramLayout_findVarByNameInType(layout: c.ProgramLayout, t: c.TypeReflection, name: []const u8) c.VariableReflection {
    return c.ProgramLayout_findVarByNameInType(layout, t, @ptrCast(name.ptr));
}

pub fn ProgramLayout_getTypeLayout(layout: c.ProgramLayout, t: c.TypeReflection, layoutRules: LayoutRules) c.TypeLayoutReflection {
    return c.ProgramLayout_getTypeLayout(layout, t, layoutRules);
}

pub fn ProgramLayout_findEntryPointReflectionByName(layout: c.ProgramLayout, name: []const u8) c.EntryPointReflection {
    return c.ProgramLayout_findEntryPointReflectionByName(layout, @ptrCast(name.ptr));
}

pub fn ProgramLayout_specializeType(layout: c.ProgramLayout, t: c.TypeReflection, specializationArgCount: c.SlangInt, specializationArgs: [*c]c.TypeReflection, outDiagnostics: *c.IBlob) c.TypeReflection {
    return c.ProgramLayout_specializeType(layout, t, specializationArgCount, @ptrCast(&specializationArgs[0]), outDiagnostics);
}

pub fn ProgramLayout_specializeGeneric(layout: c.ProgramLayout, inGeneric: c.GenericReflection, specializationArgCount: c.SlangInt, specializationArgs: [*c]c.GenericArgReflection, outDiagnostics: *c.IBlob) c.GenericReflection {
...
pub fn ProgramLayout_isSubType(layout: c.ProgramLayout, inSubType: c.TypeReflection, inSuperType: c.TypeReflection) bool {
...
pub fn ProgramLayout_getGlobalParamsTypeLayout(layout: c.ProgramLayout) c.TypeLayoutReflection {
    return c.ProgramLayout_getGlobalParamsTypeLayout(layout);
}

pub fn ProgramLayout_getGlobalParamsVarLayout(layout: c.ProgramLayout) c.VariableLayoutReflection {
    return c.ProgramLayout_getGlobalParamsVarLayout(layout);
}

pub fn VariableLayoutReflection_getVariable(layout: c.VariableLayoutReflection) c.VariableReflection {
    return c.VariableLayoutReflection_getVariable(layout);
}
pub fn VariableLayoutReflection_getName(layout: c.VariableLayoutReflection) []const u8 {
    const name = c.VariableLayoutReflection_getName(layout);
    const span = std.mem.span(name);
    return span[0..span.len];
}
pub fn VariableLayoutReflection_findModifier(layout: c.VariableLayoutReflection, id: ModifierID) c.Modifier {
    return c.VariableLayoutReflection_findModifier(layout, @intFromEnum(id));
}
pub fn VariableLayoutReflection_getTypeLayout(layout: c.VariableLayoutReflection) c.TypeLayoutReflection {
    return c.VariableLayoutReflection_getTypeLayout(layout);
}
pub fn VariableLayoutReflection_getCategory(layout: c.VariableLayoutReflection) ParameterCategory {
    return @enumFromInt(c.VariableLayoutReflection_getCategory(layout));
}
pub fn VariableLayoutReflection_getCategoryCount(layout: c.VariableLayoutReflection) u32 {
    return @intCast(c.VariableLayoutReflection_getCategoryCount(layout));
}
pub fn VariableLayoutReflection_getCategoryByIndex(layout: c.VariableLayoutReflection, index: u32) ParameterCategory {
    return @enumFromInt(c.VariableLayoutReflection_getCategoryByIndex(layout, @intCast(index)));
}
pub fn VariableLayoutReflection_getOffset(layout: c.VariableLayoutReflection, category: ParameterCategory) usize {
    return c.VariableLayoutReflection_getOffset(layout, @intFromEnum(category));
}
pub fn VariableLayoutReflection_getType(layout: c.VariableLayoutReflection) c.TypeReflection {
    return c.VariableLayoutReflection_getType(layout);
}
pub fn VariableLayoutReflection_getBindingIndex(layout: c.VariableLayoutReflection) u32 {
    return @intCast(c.VariableLayoutReflection_getBindingIndex(layout));
}
pub fn VariableLayoutReflection_getBindingSpace(layout: c.VariableLayoutReflection) u32 {
    return @intCast(c.VariableLayoutReflection_getBindingSpace(layout));
}
pub fn VariableLayoutReflection_getBindingSpaceByCategory(layout: c.VariableLayoutReflection, category: c.ParameterCategory) u32 {
    return @intCast(c.VariableLayoutReflection_getBindingSpaceByCategory(layout, @intFromEnum(category)));
}
pub fn VariableLayoutReflection_getImageFormat(layout: c.VariableLayoutReflection) ImageFormat {
    return @enumFromInt(c.VariableLayoutReflection_getImageFormat(layout));
}
pub fn VariableLayoutReflection_getSemanticName(layout: c.VariableLayoutReflection) [*c]const u8 {
    return c.VariableLayoutReflection_getSemanticName(layout);
}
pub fn VariableLayoutReflection_getSemanticIndex(layout: c.VariableLayoutReflection) u32 {
    return @intCast(c.VariableLayoutReflection_getSemanticIndex(layout));
}
pub fn VariableLayoutReflection_getSlangStage(layout: c.VariableLayoutReflection) Stage {
    return @enumFromInt(c.VariableLayoutReflection_getSlangStage(layout));
}

pub fn TypeReflection_getKind(typeLayout: c.TypeReflection) TypeKind {
    return @enumFromInt(c.TypeReflection_getKind(typeLayout));
}

pub fn TypeReflection_getFieldCount(typeLayout: c.TypeReflection) u32 {
    return c.TypeReflection_getFieldCount(typeLayout);
}

pub fn TypeReflection_getFieldByIndex(typeLayout: c.TypeReflection, index: u32) VariableReflection {
    return c.TypeReflection_getFieldByIndex(typeLayout, @intCast(index));
}

pub fn TypeReflection_isArray(typeLayout: c.TypeReflection) bool {
    return c.TypeReflection_isArray(typeLayout);
}

pub fn TypeReflection_unwrapArray(typeLayout: c.TypeReflection) TypeReflection {
    return c.TypeReflection_unwrapArray(typeLayout);
}

pub fn TypeReflection_getElementCount(typeLayout: c.TypeReflection) usize {
    return c.TypeReflection_getElementCount(typeLayout);
}

pub fn TypeReflection_getTotalArrayElementCount(typeLayout: c.TypeReflection) u32 {
    return c.TypeReflection_getTotalArrayElementCount(typeLayout);
}

pub fn TypeReflection_getElementType(typeLayout: c.TypeReflection) TypeReflection {
    return c.TypeReflection_getElementType(typeLayout);
}

pub fn TypeReflection_getRowCount(typeLayout: c.TypeReflection) u32 {
    return c.TypeReflection_getRowCount(typeLayout);
}

pub fn TypeReflection_getColumnCount(typeLayout: c.TypeReflection) u32 {
    return c.TypeReflection_getColumnCount(typeLayout);
}

pub fn TypeReflection_getScalarType(typeLayout: c.TypeReflection) ScalarType {
    return @enumFromInt(c.TypeReflection_getScalarType(typeLayout));
}

pub fn TypeReflection_getResourceResultType(typeLayout: c.TypeReflection) TypeReflection {
    return c.TypeReflection_getResourceResultType(typeLayout);
}

pub fn TypeReflection_getResourceShape(typeLayout: c.TypeReflection) ResourceShape {
    return @enumFromInt(c.TypeReflection_getResourceShape(typeLayout));
}

pub fn TypeReflection_getResourceAccess(typeLayout: c.TypeReflection) ResourceAccess {
    return @enumFromInt(c.TypeReflection_getResourceAccess(typeLayout));
}

pub fn TypeReflection_getName(typeLayout: c.TypeReflection) []const u8 {
    const name = c.TypeReflection_getName(typeLayout);
    const z = std.mem.span(name);
    return z[0..z.len];
}

pub fn TypeReflection_getUserAttributeCount(typeLayout: c.TypeReflection) u32 {
    return c.TypeReflection_getUserAttributeCount(typeLayout);
}

pub fn TypeReflection_getUserAttributeByIndex(typeLayout: c.TypeReflection, index: u32) AttributeReflection {
    return c.TypeReflection_getUserAttributeByIndex(typeLayout, @intCast(index));
}

pub fn TypeReflection_findUserAttributeByName(typeLayout: c.TypeReflection, name: []const u8) AttributeReflection {
    return c.TypeReflection_findUserAttributeByName(typeLayout, @ptrCast(name.ptr));
}

pub fn TypeReflection_findAttributeByName(typeLayout: c.TypeReflection, name: []const u8) AttributeReflection {
    return c.TypeReflection_findAttributeByName(typeLayout, @ptrCast(name.ptr));
}

pub fn TypeReflection_getGenericCountainer(typeLayout: c.TypeReflection) GenericReflection {
    return c.TypeReflection_getGenericCountainer(typeLayout);
}

pub fn VariableReflection_getName(variable: c.VariableReflection) []const u8 {
    const name = c.VariableReflection_getName(variable);
    const z = std.mem.span(name);
    return z[0..z.len];
}

pub fn VariableReflection_getType(variable: c.VariableReflection) TypeReflection {
    return c.VariableReflection_getType(variable);
}

pub fn VariableReflection_findModifier(variable: c.VariableReflection, id: ModifierID) Modifier {
    return c.VariableReflection_findModifier(variable, @intFromEnum(id));
}

pub fn VariableReflection_getUserAttributeCount(variable: c.VariableReflection) u32 {
    return @intCast(c.VariableReflection_getUserAttributeCount(variable));
}

pub fn VariableReflection_getUserAttributeByIndex(variable: c.VariableReflection, index: u32) AttributeReflection {
    return c.VariableReflection_getUserAttributeByIndex(variable, @intCast(index));
}

pub fn VariableReflection_findAttributeByName(variable: VariableReflection, inSession: IGlobalSession, name: []const u8) AttributeReflection {
    return c.VariableReflection_findAttributeByName(variable, inSession, @ptrCast(name.ptr));
}

pub fn VariableReflection_findUserAttributeByName(variable: VariableReflection, inSession: IGlobalSession, name: []const u8) AttributeReflection {
    return c.VariableReflection_findUserAttributeByName(variable, inSession, @ptrCast(name.ptr));
}

pub fn VariableReflection_hasDefaultValue(variable: c.VariableReflection) bool {
    return c.VariableReflection_hasDefaultValue(variable);
}

pub fn VariableReflection_getDefaultValue(variable: VariableReflection, value: *i64) SlangResult {
    return @enumFromInt(c.VariableReflection_getDefaultValue(variable, value));
}

pub fn VariableReflection_getGenericContainer(variable: VariableReflection) GenericReflection {
    return c.VariableReflection_getGenericContainer(variable);
}

pub fn VariableReflection_applySpecializations(variable: VariableReflection, inGeneric: GenericReflection) VariableReflection {
    return c.VariableReflection_applySpecializations(variable, inGeneric);
}

pub fn TypeLayoutReflection_getType(layout: TypeLayoutReflection) TypeReflection {
    return c.TypeLayoutReflection_getType(layout);
}

pub fn TypeLayoutReflection_getKind(layout: TypeLayoutReflection) TypeKind {
    return @enumFromInt(c.TypeLayoutReflection_getKind(layout));
}

pub fn TypeLayoutReflection_getSize(layout: TypeLayoutReflection, category: ParameterCategory) usize {
    return c.TypeLayoutReflection_getSize(layout, @intFromEnum(category));
}

pub fn TypeLayoutReflection_getStride(layout: TypeLayoutReflection, category: ParameterCategory) usize {
    return c.TypeLayoutReflection_getStride(layout, @intFromEnum(category));
}

pub fn TypeLayoutReflection_getAlignment(layout: TypeLayoutReflection, category: ParameterCategory) i32 {
    return c.TypeLayoutReflection_getAlignment(layout, @intFromEnum(category));
}

pub fn TypeLayoutReflection_getFieldCount(layout: TypeLayoutReflection) u32 {
    return c.TypeLayoutReflection_getFieldCount(layout);
}

pub fn TypeLayoutReflection_getFieldByIndex(layout: TypeLayoutReflection, index: u32) VariableLayoutReflection {
    return c.TypeLayoutReflection_getFieldByIndex(layout, index);
}

pub fn TypeLayoutReflection_getExplicitCounter(layout: TypeLayoutReflection) VariableLayoutReflection {
    return c.TypeLayoutReflection_getExplicitCounter(layout);
}

pub fn TypeLayoutReflection_isArray(layout: TypeLayoutReflection) bool {
    return c.TypeLayoutReflection_isArray(layout);
}

pub fn TypeLayoutReflection_unwrapArray(layout: TypeLayoutReflection) TypeLayoutReflection {
    return c.TypeLayoutReflection_unwrapArray(layout);
}

pub fn TypeLayoutReflection_getElementCount(layout: TypeLayoutReflection, reflection: ShaderReflection) u32 {
    return c.TypeLayoutReflection_getElementCount(layout, reflection);
}

pub fn TypeLayoutReflection_getTotalElementCount(layout: TypeLayoutReflection) usize {
    return c.TypeLayoutReflection_getTotalElementCount(layout);
}

pub fn TypeLayoutReflection_getElementStride(layout: TypeLayoutReflection, category: ParameterCategory) usize {
    return c.TypeLayoutReflection_getElementStride(layout, @intFromEnum(category));
}

pub fn TypeLayoutReflection_getElementTypeLayout(layout: TypeLayoutReflection) TypeLayoutReflection {
    return c.TypeLayoutReflection_getElementTypeLayout(layout);
}

pub fn TypeLayoutReflection_getElementVarLayout(layout: TypeLayoutReflection) VariableLayoutReflection {
    return c.TypeLayoutReflection_getElementVarLayout(layout);
}

pub fn TypeLayoutReflection_getContainerVarLayout(layout: TypeLayoutReflection) VariableLayoutReflection {
    return c.TypeLayoutReflection_getContainerVarLayout(layout);
}

pub fn TypeLayoutReflection_getParameterCategory(layout: TypeLayoutReflection) ParameterCategory {
    return @enumFromInt(c.TypeLayoutReflection_getParameterCategory(layout));
}

pub fn TypeLayoutReflection_getCategoryCount(layout: TypeLayoutReflection) u32 {
    return c.TypeLayoutReflection_getCategoryCount(layout);
}

pub fn TypeLayoutReflection_getCategoryByIndex(layout: TypeLayoutReflection, index: u32) ParameterCategory {
    return @enumFromInt(c.TypeLayoutReflection_getCategoryByIndex(layout, index));
}

pub fn TypeLayoutReflection_getRowCount(layout: TypeLayoutReflection) u32 {
    return c.TypeLayoutReflection_getRowCount(layout);
}

pub fn TypeLayoutReflection_getColumnCount(layout: TypeLayoutReflection) u32 {
    return c.TypeLayoutReflection_getColumnCount(layout);
}

pub fn TypeLayoutReflection_getScalarType(layout: TypeLayoutReflection) ScalarType {
    return @enumFromInt(c.TypeLayoutReflection_getScalarType(layout));
}

pub fn TypeLayoutReflection_getResourceResultType(layout: TypeLayoutReflection) TypeReflection {
    return c.TypeLayoutReflection_getResourceResultType(layout);
}

pub fn TypeLayoutReflection_getResourceShape(layout: TypeLayoutReflection) ResourceShape {
    return @enumFromInt(c.TypeLayoutReflection_getResourceShape(layout));
}

pub fn TypeLayoutReflection_getResourceAccess(layout: TypeLayoutReflection) ResourceAccess {
    return @enumFromInt(c.TypeLayoutReflection_getResourceAccess(layout));
}

pub fn TypeLayoutReflection_getName(layout: TypeLayoutReflection) []const u8 {
    const name = c.TypeLayoutReflection_getName(layout);
    const z = std.mem.span(name);
    return z[0..z.len];
}

pub fn TypeLayoutReflection_getMatrixLayoutMode(layout: TypeLayoutReflection) MatrixLayoutMode {
    return @enumFromInt(c.TypeLayoutReflection_getMatrixLayoutMode(layout));
}

pub fn TypeLayoutReflection_getGenericParamIndex(layout: TypeLayoutReflection) i32 {
    return c.TypeLayoutReflection_getGenericParamIndex(layout);
}

pub fn TypeLayoutReflection_getBindingRangeCount(layout: TypeLayoutReflection) c.SlangInt {
    return c.TypeLayoutReflection_getBindingRangeCount(layout);
}

pub fn TypeLayoutReflection_getBindingRangeType(layout: TypeLayoutReflection, index: c.SlangInt) BindingType {
    return @enumFromInt(c.TypeLayoutReflection_getBindingRangeType(layout, index));
}

pub fn TypeLayoutReflection_isBindingRangeSpecializable(layout: TypeLayoutReflection, index: c.SlangInt) bool {
    return c.TypeLayoutReflection_isBindingRangeSpecializable(layout, index);
}

pub fn TypeLayoutReflection_getBindingRangeBindingCount(layout: TypeLayoutReflection, index: c.SlangInt) c.SlangInt {
    return c.TypeLayoutReflection_getBindingRangeBindingCount(layout, index);
}

pub fn TypeLayoutReflection_getFieldBindingRangeOffset(layout: TypeLayoutReflection, index: c.SlangInt) c.SlangInt {
    return c.TypeLayoutReflection_getFieldBindingRangeOffset(layout, index);
}

pub fn TypeLayoutReflection_getExplicitCounterBindingRangeOffset(layout: TypeLayoutReflection) c.SlangInt {
    return c.TypeLayoutReflection_getExplicitCounterBindingRangeOffset(layout);
}

pub fn TypeLayoutReflection_getBindingRangeLeafTypeLayout(layout: TypeLayoutReflection, index: c.SlangInt) TypeLayoutReflection {
    return c.TypeLayoutReflection_getBindingRangeLeafTypeLayout(layout, index);
}

pub fn TypeLayoutReflection_getBindingRangeImageFormat(layout: TypeLayoutReflection, index: c.SlangInt) ImageFormat {
    return @enumFromInt(c.TypeLayoutReflection_getBindingRangeImageFormat(layout, index));
}

pub fn TypeLayoutReflection_getBindingRangeDescriptorSetIndex(layout: TypeLayoutReflection, index: c.SlangInt) c.SlangInt {
    return c.TypeLayoutReflection_getBindingRangeDescriptorSetIndex(layout, index);
}

pub fn TypeLayoutReflection_getBindingRangeFirstDescriptorRangeIndex(layout: TypeLayoutReflection, index: c.SlangInt) c.SlangInt {
    return c.TypeLayoutReflection_getBindingRangeFirstDescriptorRangeIndex(layout, index);
}

pub fn TypeLayoutReflection_getBindingRangeDescriptorRangeCount(layout: TypeLayoutReflection, index: c.SlangInt) c.SlangInt {
    return c.TypeLayoutReflection_getBindingRangeDescriptorRangeCount(layout, index);
}

pub fn TypeLayoutReflection_getDescriptorSetCount(layout: TypeLayoutReflection) c.SlangInt {
    return c.TypeLayoutReflection_getDescriptorSetCount(layout);
}

pub fn TypeLayoutReflection_getDescriptorSetSpaceOffset(layout: TypeLayoutReflection, setIndex: c.SlangInt) c.SlangInt {
    return c.TypeLayoutReflection_getDescriptorSetSpaceOffset(layout, setIndex);
}

pub fn TypeLayoutReflection_getDescriptorSetDescriptorRangeCount(layout: TypeLayoutReflection, setIndex: c.SlangInt) c.SlangInt {
    return c.TypeLayoutReflection_getDescriptorSetDescriptorRangeCount(layout, setIndex);
}

pub fn TypeLayoutReflection_getDescriptorSetDescriptorRangeIndexOffset(layout: TypeLayoutReflection, setIndex: c.SlangInt, rangeIndex: c.SlangInt) c.SlangInt {
    return c.TypeLayoutReflection_getDescriptorSetDescriptorRangeIndexOffset(layout, setIndex, rangeIndex);
}

pub fn TypeLayoutReflection_getDescriptorSetDescriptorRangeDescriptorCount(layout: TypeLayoutReflection, setIndex: c.SlangInt, rangeIndex: c.SlangInt) c.SlangInt {
    return c.TypeLayoutReflection_getDescriptorSetDescriptorRangeDescriptorCount(layout, setIndex, rangeIndex);
}

pub fn TypeLayoutReflection_getDescriptorSetDescriptorRangeType(layout: TypeLayoutReflection, setIndex: c.SlangInt, rangeIndex: c.SlangInt) BindingType {
    return @enumFromInt(c.TypeLayoutReflection_getDescriptorSetDescriptorRangeType(layout, setIndex, rangeIndex));
}

pub fn TypeLayoutReflection_getDescriptorSetDescriptorRangeCategory(layout: TypeLayoutReflection, setIndex: c.SlangInt, rangeIndex: c.SlangInt) ParameterCategory {
    return c.TypeLayoutReflection_getDescriptorSetDescriptorRangeCategory(layout, setIndex, rangeIndex);
}

pub fn TypeLayoutReflection_getSubObjectRangeCount(layout: TypeLayoutReflection) c.SlangInt {
    return c.TypeLayoutReflection_getSubObjectRangeCount(layout);
}

pub fn TypeLayoutReflection_getSubObjectRangeBindingRangeIndex(layout: TypeLayoutReflection, subObjectRangeIndex: c.SlangInt) c.SlangInt {
    return c.TypeLayoutReflection_getSubObjectRangeBindingRangeIndex(layout, subObjectRangeIndex);
}

pub fn TypeLayoutReflection_getSubObjectRangeSpaceOffset(layout: TypeLayoutReflection, subObjectRangeIndex: c.SlangInt) c.SlangInt {
    return c.TypeLayoutReflection_getSubObjectRangeSpaceOffset(layout, subObjectRangeIndex);
}

pub fn TypeLayoutReflection_getSubObjectRangeOffset(layout: TypeLayoutReflection, subObjectRangeIndex: c.SlangInt) VariableLayoutReflection {
    return c.TypeLayoutReflection_getSubObjectRangeOffset(layout, subObjectRangeIndex);
}

pub fn EntryPointReflection_getName(entryPoint: EntryPointReflection) []const u8 {
    return std.mem.sliceTo(c.EntryPointReflection_getName(entryPoint), 0);
}

pub fn EntryPointReflection_getNameOverride(entryPoint: EntryPointReflection) []const u8 {
    const name = c.EntryPointReflection_getNameOverride(entryPoint);
    const span = std.mem.span(name);
    return span[0..span.len];
}

pub fn EntryPointReflection_getParameterCount(entryPoint: EntryPointReflection) u32 {
    return c.EntryPointReflection_getParameterCount(entryPoint);
}

pub fn EntryPointReflection_getFunction(entryPoint: EntryPointReflection) FunctionReflection {
    return c.EntryPointReflection_getFunction(entryPoint);
}

pub fn EntryPointReflection_getParameterByIndex(entryPoint: EntryPointReflection, index: u32) VariableLayoutReflection {
    return c.EntryPointReflection_getParameterByIndex(entryPoint, index);
}

pub fn EntryPointReflection_getStage(entryPoint: EntryPointReflection) Stage {
    return @enumFromInt(c.EntryPointReflection_getStage(entryPoint));
}

pub fn EntryPointReflection_getComputeThreadGroupSize(entryPoint: EntryPointReflection, axisCount: u32, outSizeAlongAxis: *u64) void {
    return c.EntryPointReflection_getComputeThreadGroupSize(entryPoint, axisCount, outSizeAlongAxis);
}

pub fn EntryPointReflection_getComputeWaveSize(entryPoint: EntryPointReflection, outWaveSize: *u32) void {
    return c.EntryPointReflection_getComputeWaveSize(entryPoint, outWaveSize);
}

pub fn EntryPointReflection_usesAnySampleRateInput(entryPoint: EntryPointReflection) bool {
    return c.EntryPointReflection_usesAnySampleRateInput(entryPoint);
}

pub fn EntryPointReflection_getVarLayout(entryPoint: EntryPointReflection) VariableLayoutReflection {
    return c.EntryPointReflection_getVarLayout(entryPoint);
}

pub fn EntryPointReflection_getTypeLayout(entryPoint: EntryPointReflection) TypeLayoutReflection {
    return c.EntryPointReflection_getTypeLayout(entryPoint);
}

pub fn EntryPointReflection_getResultVarLayout(entryPoint: EntryPointReflection) VariableLayoutReflection {
    return c.EntryPointReflection_getResultVarLayout(entryPoint);
}

pub fn EntryPointReflection_hasDefaultConstantBuffer(entryPoint: EntryPointReflection) bool {
    return c.EntryPointReflection_hasDefaultConstantBuffer(entryPoint);
}

pub fn TypeParameterReflection_getName(typeParameter: TypeParameterReflection) []const u8 {
    return std.mem.sliceTo(c.TypeParameterReflection_getName(typeParameter), 0);
}

pub fn TypeParameterReflection_getIndex(typeParameter: TypeParameterReflection) u32 {
    return c.TypeParameterReflection_getIndex(typeParameter);
}

pub fn TypeParameterReflection_getConstraintCount(typeParameter: TypeParameterReflection) u32 {
    return c.TypeParameterReflection_getConstraintCount(typeParameter);
}

pub fn TypeParameterReflection_getConstraintByIndex(typeParameter: TypeParameterReflection, index: u32) TypeReflection {
...
pub fn AttributeReflection_getName(self: AttributeReflection) []const u8 {
    return std.mem.sliceTo(c.AttributeReflection_getName(self), 0);
}

pub fn AttributeReflection_getArgumentCount(self: AttributeReflection) u32 {
    return c.AttributeReflection_getArgumentCount(self);
}

pub fn AttributeReflection_getArgumentType(self: AttributeReflection, index: u32) TypeReflection {
    return c.AttributeReflection_getArgumentType(self, index);
}

pub fn AttributeReflection_getArgumentValueInt(self: AttributeReflection, index: u32, value: *i32) SlangResult {
    return @enumFromInt(c.AttributeReflection_getArgumentValueInt(self, index, value));
}

pub fn AttributeReflection_getArgumentValueFloat(self: AttributeReflection, index: u32, value: *f32) SlangResult {
    return @enumFromInt(c.AttributeReflection_getArgumentValueFloat(self, index, value));
}

pub fn AttributeReflection_getArgumentValueString(self: AttributeReflection, index: u32) []const u8 {
    var outSize: usize = undefined;
    return std.mem.sliceTo(c.AttributeReflection_getArgumentValueString(self, index, &outSize), 0);
}

pub fn FunctionReflection_getName(self: FunctionReflection) []const u8 {
    return std.mem.sliceTo(c.FunctionReflection_getName(self), 0);
}

pub fn FunctionReflection_getReturnType(self: FunctionReflection) TypeReflection {
    return c.FunctionReflection_getReturnType(self);
}

pub fn FunctionReflection_getParameterCount(self: FunctionReflection) u32 {
    return c.FunctionReflection_getParameterCount(self);
}

pub fn FunctionReflection_getParameterByIndex(self: FunctionReflection, index: u32) VariableReflection {
    return c.FunctionReflection_getParameterByIndex(self, index);
}

pub fn FunctionReflection_getUserAttributeCount(self: FunctionReflection) u32 {
    return c.FunctionReflection_getUserAttributeCount(self);
}

pub fn FunctionReflection_getUserAttributeByIndex(self: FunctionReflection, index: u32) AttributeReflection {
    return c.FunctionReflection_getUserAttributeByIndex(self, index);
}

pub fn FunctionReflection_findAttributeByName(self: FunctionReflection, name: []const u8) AttributeReflection {
    return c.FunctionReflection_findAttributeByName(self, name.ptr);
}

pub fn FunctionReflection_findModifier(self: FunctionReflection, id: ModifierID) Modifier {
    return c.FunctionReflection_findModifier(self, @enumFromInt(id));
}

pub fn FunctionReflection_getGenericContainer(self: FunctionReflection) GenericReflection {
    return c.FunctionReflection_getGenericContainer(self);
}

pub fn FunctionReflection_applySpecializations(self: FunctionReflection, inGeneric: GenericReflection) FunctionReflection {
    return c.FunctionReflection_applySpecializations(self, inGeneric);
}

pub fn FunctionReflection_specializeWithArgTypes(self: FunctionReflection, argCount: u32, types: []const TypeReflection) FunctionReflection {
    return c.FunctionReflection_specializeWithArgTypes(self, argCount, types.ptr);
}

pub fn FunctionReflection_isOverloaded(self: FunctionReflection) bool {
    return c.FunctionReflection_isOverloaded(self);
}

pub fn FunctionReflection_getOverloadCount(self: FunctionReflection) u32 {
    return c.FunctionReflection_getOverloadCount(self);
}

pub fn FunctionReflection_getOverload(self: FunctionReflection, index: u32) FunctionReflection {
